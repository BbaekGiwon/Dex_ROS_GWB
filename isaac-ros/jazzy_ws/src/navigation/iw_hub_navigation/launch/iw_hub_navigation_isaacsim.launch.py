    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "gui",
                default_value="https://omniverse-content-production.s3-us-west-2.amazonaws.com/Assets/Isaac/5.0/Isaac/Samples/ROS2/Scenario/iw_hub_warehouse_navigation.usd",
